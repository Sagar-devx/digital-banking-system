...
class AccountServiceImplTest {
    ...
    void createAccount_DuplicateEmail() {
        ...
        assertEquals("Account already exists with email: " + request.getEmail(), exception.getMessage());
    ...
    void deductBalance_AccountNotActive() {
        ...
        assertEquals("Account is not active. Current status: " + AccountStatus.CLOSED, exception.getMessage());
        verify(accountRepository, never()).save(any(Account.class));
    }
    ...
    void deductBalance_InsufficientFunds() {
        ...
        assertEquals("Insufficient funds in account: " + accountNumber + ". Current balance: " + account.getBalance() + ", requested: 5000", exception.getMessage());
        verify(accountRepository, never()).save(any(Account.class));
    }
