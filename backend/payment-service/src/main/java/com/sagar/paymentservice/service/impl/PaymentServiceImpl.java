...
public class PaymentServiceImpl implements PaymentService {
    ...
    public void confirmPayment(ConfirmPaymentRequest request) {
        Payment payment = paymentRepository.findByRazorpayOrderId(request.getRazorpayOrderId())
                .orElseThrow(() -> new PaymentNotFoundException("Payment record not found for orderId: " + request.getRazorpayOrderId()));
        ...
        log.info("Payment confirmed from frontend: {}", payment.getId());
    }
    @Override
    ...
    private void handlePaymentFailure(Map<String, Object> payload) {
        ...
        try{
            ...
            Payment payment = paymentRepository.findByRazorpayOrderId(orderId)
                    .orElseThrow(() -> new PaymentNotFoundException("Payment record not found for orderId: " + orderId));
