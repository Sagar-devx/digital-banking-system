...
class FraudDetectionServiceImplTest {
    ...
    @Test
    @DisplayName("Check transaction throws InvalidTransactionPayloadException when payload is null or incomplete")
    void checkTransaction_InvalidPayload() {
        Map<String, Object> payload = new HashMap<>();
        payload.put("transactionId", "tx-999");
        // Missing senderAccountNumber and amount

        org.junit.jupiter.api.Assertions.assertThrows(
                com.sagar.frauddetectionservice.exception.InvalidTransactionPayloadException.class,
                () -> fraudDetectionService.checkTransaction(payload)
        );
    }
}
